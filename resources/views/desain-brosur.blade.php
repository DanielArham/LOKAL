          ...
          <div class="col-12 col-md-4 spc">
            <div class="card features shadow-lg">
              ...
              <div class="bottom-pos text-center">
                <button class="btn btn-info shadow-lg" onclick="order('Desain Brosur Paket Kaki 5')">Pesan</button>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-4 spc">
            <div class="card features shadow-lg">
              ...
              <div class="bottom-pos text-center">
                <button class="btn btn-info shadow-lg" onclick="order('Desain Brosur Paket Istimewa')">Pesan</button>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-4 spc">
            <div class="card features shadow-lg">
              ...
              <div class="bottom-pos text-center">
                <button class="btn btn-info shadow-lg" onclick="order('Desain Brosur Paket Bintang 5')">Pesan</button>
              </div>
            </div>
          </div>
        </div>
