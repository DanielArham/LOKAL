...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="Jasa desain brosur untuk segala kebutuhan Anda. Fokus ke bisnis Anda, urusan desain serahkan ke kami."
    />
    <meta name="author" content="LOKAL." />
    <title>Desain Brosur | LOKAL.</title>
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="nav1">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link" href="#">Desain Brosur</a>
            </li>
            <li class="nav-item">
        ...
        <div class="row">
          ...
          <div class="col-12 col-md-8 my-auto order-md-1">
            <div class="info-jumbo">
              <h1>Desain Brosur</h1>
              <p>
                Brosur adalah salah satu media penyampaian yang efektif untuk menyampaikan informasi yang kita inginkan.
              </p>
    ...
    <section id="products" class="section" style="background-color: #f3f3f3">
      <div class="container">
        <h1 class="text-center">Paket Desain Brosur</h1>
          ...
          <div class="col-12 col-md-4 spc">
            <div class="card features shadow-lg">
              ...
              <div class="bottom-pos text-center">
                <button class="btn btn-info shadow-lg" onclick="redirectToCheckout('/checkout', 'Brosur Paket Kaki 5', 50000)">Pesan</button>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-4 spc">
            <div class="card features shadow-lg">
              ...
              <div class="bottom-pos text-center">
                <button class="btn btn-info shadow-lg" onclick="redirectToCheckout('/checkout', 'Brosur Paket Istimewa', 250000)">Pesan</button>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-4 spc">
            <div class="card features shadow-lg">
              ...
              <div class="bottom-pos text-center">
                <button class="btn btn-info shadow-lg" onclick="redirectToCheckout('/checkout', 'Brosur Paket Bintang 5', 1000000)">Pesan</button>
              </div>
            </div>
          </div>
        </div>
    ...
    <section id="review" class="section">
      <div class="container">
        <h1 class="text-center">Portofolio Desain Brosur</h1>
        <br /><br />

        <div class="row">
          <div class="text-center gallery_product col-lg-5 col-md-5 col-sm-12 col-xs-12">
            <img src="{{ asset('portofolio/brosur1.png') }}" class="img-fluid" />
          </div>
          <div class="text-center gallery_product col-lg-2 col-md-2 col-sm-4 col-xs-12">
            <img src="{{ asset('portofolio/brosur2.png') }}" class="img-fluid" />
          </div>
          <div class="text-center gallery_product col-lg-2 col-md-2 col-sm-4 col-xs-12">
            <img src="{{ asset('portofolio/brosur3.png') }}" class="img-fluid" />
          </div>
          <div class="text-center gallery_product col-lg-2 col-md-2 col-sm-4 col-xs-12">
            <img src="{{ asset('portofolio/brosur4.png') }}" class="img-fluid" />
          </div>
        </div>
      </div>
    </section>
    ...
    <a id="back-to-top" href="#" class="btn btn-info btn-lg back-to-top" role="button"
      ><img src="img/top.png" width="15px"
    /></a>
