          ...
          <div class="col-12 col-md-4 spc">
            <div class="card features shadow-lg">
              ...
              <div class="bottom-pos text-center">
                <button class="btn btn-yellow shadow-lg" onclick="redirectToCheckout('/checkout', 'Brosur Paket Kaki 5', 50000)">Pesan</button>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-4 spc">
            <div class="card features shadow-lg">
              ...
              <div class="bottom-pos text-center">
                <button class="btn btn-yellow shadow-lg" onclick="redirectToCheckout('/checkout', 'Brosur Paket Istimewa', 250000)">Pesan</button>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-4 spc">
            <div class="card features shadow-lg">
              ...
              <div class="bottom-pos text-center">
                <button class="btn btn-yellow shadow-lg" onclick="redirectToCheckout('/checkout', 'Brosur Paket Bintang 5', 1000000)">Pesan</button>
              </div>
            </div>
          </div>
        </div>
